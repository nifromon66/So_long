...
/*   Updated: 2025/01/23 20:07:49 by nifromon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define COLLECT	"./assets/collect/collect.xpm"
	// Player Basic
# define PLAYERR0	"./assets/player/player_right/player_right.xpm"
# define PLAYERL0	"./assets/player/player_left/player_left.xpm"
	// Player on exit off
# define PLAYER_RE0	"./assets/player/on_exit_right/player_on_exit_right.xpm"
# define PLAYER_LE0	"./assets/player/on_exit_left/player_on_exit_left.xpm"
...
void	mlx_update_putback(int move, int pos[], t_mlx **mlx);
